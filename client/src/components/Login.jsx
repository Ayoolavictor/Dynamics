...
//components that handles the input function for the forms
...
const Login=()=>{
  ...
  // Function that will handle the Deposit collateral button
  const handleDeposit=(e)=>{
    e.preventDefault();
    borrowersCollateral();
  };
  //Function that will handle the withdraw loan button
  const handleWithdrawLoan=(e)=>{
    e.preventDefault();
    withdraw();
  }

  //Function that will handle the invest button for the lenders 
